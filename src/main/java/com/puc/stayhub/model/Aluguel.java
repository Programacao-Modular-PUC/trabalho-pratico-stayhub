...
* Aluguel de um quarto por um cliente em um intervalo de datas.
* O valor total e calculado no momento da reserva, multiplicando-se o valor da
* diaria (calculado pelo proprio Quarto) pela quantidade de diarias.
@Id
...
/**
*/
* Calcula a quantidade de diarias do periodo (minimo 1).
/**
...
/**
*/
* Recalcula valorDiaria e valorTotal usando a regra de calculo do quarto.
